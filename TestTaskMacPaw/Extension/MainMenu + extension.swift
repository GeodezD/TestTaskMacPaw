...
extension MainMenu: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            cell.setLabel(with: "Statistics of total lost",
                          bold: .textBoldTrue)
        case 1:
            cell.setImage(imageName: "Fire car")
            cell.setLabel(with: "Lost military equipment",
                          bold: .textBoldTrue)
        default:
            break
        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case 1:
            let nextPageAllStatistics = LostMilitaryEquipment()
            navigationController?.pushViewController(nextPageAllStatistics, animated: true)
        default:
            break
        }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: collectionView.frame.width - 2,
                      height: collectionView.frame.width / 1.15)
    }
}
