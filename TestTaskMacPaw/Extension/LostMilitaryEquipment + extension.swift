//
//  LostMilitaryEquipment + extension.swift
//  TestTaskMacPaw
//
...
extension LostMilitaryEquipment: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
